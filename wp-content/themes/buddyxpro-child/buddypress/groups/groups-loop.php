...
<?php
	$enable_card_view = get_theme_mod( 'buddypress_groups_directory_view', buddyx_defaults( 'buddypress-groups-directory-view' ) );
	$card_class = '';
...
<?php if ( bp_has_groups( bp_ajax_querystring( 'groups' ) ) ) : ?>
	...
	?>
		...
		<li <?php bp_group_class( array( 'item-entry' ) ); ?> data-bp-item-id="<?php bp_group_id(); ?>" data-bp-item-component="groups">
			<div class="list-wrap <?php echo $card_class ?>">
					...
					<div class="item-block">
						...
						<p class="last-activity item-meta">
							...
							printf(
								...
								__( 'active %s', 'buddyxpro' ), // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
