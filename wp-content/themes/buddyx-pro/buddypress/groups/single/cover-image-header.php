...
$cover_layout = get_theme_mod( 'buddypress_single_group_view', 'full' );
				...
				if ( function_exists( 'buddypress' ) && isset( buddypress()->buddyboss ) ) {
					if ( ! empty( $group_cover_image ) && bp_is_item_admin() ) {
						...
						<div class="header-cover-reposition-wrap">
							<a href="#" class="button small cover-image-cancel"><?php esc_html_e( 'Cancel', 'buddyxpro' ); ?></a>
							<a href="#" class="button small cover-image-save"><?php esc_html_e( 'Save Changes', 'buddyxpro' ); ?></a>
							<span class="drag-element-helper"><i class="bb-icon-menu"></i><?php esc_html_e( 'Drag to move cover photo', 'buddyxpro' ); ?></span>
							<img src="<?php echo esc_url( $group_cover_image ); ?>" alt="<?php esc_attr_e( 'Cover photo', 'buddyxpro' ); ?>" />
						</div>
						<?php
					}
				}
