...
$bp_nav_view = get_theme_mod( 'buddypress_single_member_nav_view', 'swipe' );
...
?>
    ...
    <div class="container">
        <div class="site-wrapper member-home <?php echo esc_attr( $class); ?> <?php echo esc_attr( $nav_view); ?>">
            <div class="bp-wrap">
