<?php
/**
 * BuddyxPro\BuddyxPro\Accessibility\Component class
 *
 * @package buddyxpro
 */

namespace BuddyxPro\BuddyxPro\Accessibility;
...
class Component implements Component_Interface {
	...
	public function action_enqueue_navigation_script() {
		...
		wp_enqueue_script(
			'buddyxpro-navigation',
			get_theme_file_uri( '/assets/js/navigation.min.js' ),
			[],
			buddyxpro()->get_asset_version( get_theme_file_path( '/assets/js/navigation.min.js' ) ),
			true
		);
		wp_script_add_data( 'buddyxpro-navigation', 'async', true );
		wp_script_add_data( 'buddyxpro-navigation', 'precache', true );
		wp_localize_script(
			'buddyxpro-navigation',
			'buddyxproScreenReaderText',
			[
				'expand'   => __( 'Expand child menu', 'buddyxpro' ),
				'collapse' => __( 'Collapse child menu', 'buddyxpro' ),
			]
		);
	}
