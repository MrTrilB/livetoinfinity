<?php
/**
 * BuddyxPro\BuddyxPro\Nav_Menus\Component class
 *
 * @package buddyxpro
 */

namespace BuddyxPro\BuddyxPro\Nav_Menus;
 ...
 * * `buddyxpro()->is_primary_nav_menu_active()`
 * * `buddyxpro()->display_primary_nav_menu( array $args = [] )`
 */
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function action_register_nav_menus() {
		register_nav_menus(
			[
				static::PRIMARY_NAV_MENU_SLUG => esc_html__( 'Primary', 'buddyxpro' ),
			]
		);
		//if ( class_exists( 'BuddyPress' ) ) {
			register_nav_menus(
				[
					static::BUDDYPRESS_NAV_MENU_SLUG => esc_html__( 'User Menu', 'buddyxpro' ),
				]
			);
		//}
	}
	 ...
	 */
	public function filter_primary_nav_menu_dropdown_symbol( string $item_output, $item, int $depth, $args ) : string {
