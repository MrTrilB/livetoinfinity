<?php
/**
 * BuddyxPro\BuddyxPro\Customizer\Component class
 *
 * @package buddyxpro
 */

namespace BuddyxPro\BuddyxPro\Customizer;
...
class Component implements Component_Interface {
	...
	public function action_customize_register( WP_Customize_Manager $wp_customize ) {
		...
		$wp_customize->add_section(
			'theme_options',
			[
				'title'    => __( 'Theme Options', 'buddyxpro' ),
	...
	public function action_enqueue_customize_preview_js() {
		wp_enqueue_script(
			'buddyxpro-customizer',
			get_theme_file_uri( '/assets/js/customizer.min.js' ),
			[ 'customize-preview' ],
			buddyxpro()->get_asset_version( get_theme_file_path( '/assets/js/customizer.min.js' ) ),
			true
		);
	}
}
