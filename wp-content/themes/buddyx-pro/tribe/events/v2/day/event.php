...
?>
<div class="buddyx-tribe-events-calendar-event-wrapper buddyx-tribe-events-calendar-day-event-wrapper">
	<article <?php tribe_classes( $classes ); ?>>
		<div class="tribe-events-calendar-day__event-content">

			<?php $this->template( 'day/event/featured-image', array( 'event' => $event ) ); ?>

			<div class="tribe-events-calendar-day__event-details buddyx-tribe-events-calendar-event-details">
