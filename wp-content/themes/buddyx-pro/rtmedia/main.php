...
if ( bp_is_group() ) {
	if ( bp_has_groups() ) :
		while ( bp_groups() ) :
            ...
            <div class="container">
                <div class="site-wrapper group-home <?php echo $grpclass ?>">
			        <div class="bp-wrap">
                        <?php
                        ...
                        <div id="item-body" class="item-body">
                            <div class="item-body-inner-wrapper">
                                ...
                                <nav class="rtm-bp-navs bp-navs bp-subnavs no-ajax user-subnav" id="subnav" role="navigation" aria-label="<?php esc_attr_e( 'Notifications menu', 'buddyxpro' ); ?>">
                                    <ul class="subnav">
                                        <?php rtmedia_sub_nav(); ?>
...
<div class="container">
    <div class="site-wrapper member-home <?php echo $memclass ?>">
        <div class="bp-wrap">
        <?php
