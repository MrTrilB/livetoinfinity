...
if ( $rule['display_error'] ) bp_core_add_message( __( 'Sorry, you are not allowed to create groups.', 'buddypress' ) .' '. __( 'Reason: membership duration', 'buddypress-restrict-grouo-creation' ), 'warning' );
			return false;
		}
	}
...
if ( $rule['display_error'] ) bp_core_add_message( __( 'Sorry, you are not allowed to create groups.', 'buddypress' ) .' '. __( 'Reason: friend count', 'buddypress-restrict-grouo-creation' ), 'warning' );
			return false;
		}
	}
...
if ( $rule['display_error'] ) bp_core_add_message( __( 'Sorry, you are not allowed to create groups.', 'buddypress' ) .' '. __( 'Reason: activity updates', 'buddypress-restrict-grouo-creation' ), 'warning' );
			return false;
		}
	}
...
if ( $rule['display_error'] ) bp_core_add_message( __( 'Sorry, you are not allowed to create groups.', 'buddypress' ) .' '. __( 'Reason: groups created', 'buddypress-restrict-grouo-creation' ), 'warning' );
			return false;
		}
	}
...
if ( $rule['display_error'] ) bp_core_add_message( __( 'Sorry, you are not allowed to create groups.', 'buddypress' ) .' '. __( 'Reason: group adminstrator', 'buddypress-restrict-grouo-creation' ), 'warning' );
			return false;
		}
	}
    if ( $rule['bp_restrictgroups_membership_count']['enabled'] ) {
		$membership_total = count( BP_Groups_Member::get_membership_ids_for_user( $bp->loggedin_user->id ) );
		if ( $membership_total >= $rule['bp_restrictgroups_membership_count']['count'] ) {
if ( $rule['display_error'] ) bp_core_add_message( __( 'Sorry, you are not allowed to create groups.', 'buddypress' ) .' '. __( 'Reason: group memberships', 'buddypress-restrict-grouo-creation' ), 'warning' );
			return false;
		}
	}
...
if ( $rule['display_error'] ) bp_core_add_message( __( 'Sorry, you are not allowed to create groups.', 'buddypress' ) .' '. __( 'Reason: group moderator', 'buddypress-restrict-grouo-creation' ), 'warning' );
			return false;
		}
	}
...
if ( $rule['display_error'] ) bp_core_add_message( __( 'Sorry, you are not allowed to create groups.', 'buddypress' ) .' '. __( 'Reason: group forum posting', 'buddypress-restrict-grouo-creation' ), 'warning' );
			return false;
		}
	}
...
if ( $rule['display_error'] ) bp_core_add_message( __( 'Sorry, you are not allowed to create groups.', 'buddypress' ) .' '. __( 'Reason: achievements', 'buddypress-restrict-grouo-creation' ), 'warning' );
				return false;
		}
		}
