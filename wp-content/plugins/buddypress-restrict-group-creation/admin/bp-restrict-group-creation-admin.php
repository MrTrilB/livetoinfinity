...
?>	
	<div class="wrap">
		<h2><?php _e( 'Restrict Group Creation', 'buddypress-restrict-grouo-creation' ); ?></h2>

		<?php if ( isset($updated) ) : echo "<div id='message' class='updated fade'><p>" . __( 'Rule Added.', 'buddypress-restrict-grouo-creation' ) . "</p></div>"; endif;
		if ( isset($removed) && !isset($error) ) : echo "<div id='message' class='updated fade'><p>" . __( 'Removed rule.', 'buddypress-restrict-grouo-creation' ) . "</p></div>"; endif;
		if ( isset($error) ) { 
					...
					foreach ($rules as $key => $value) { ?>
						<tr class="alternate">
						 ...
						 <td class="username column-restrictions">
							...
							echo "<p>Max Group Memberships: ", ($value['bp_restrictgroups_membership_count']['enabled'] ? '<span style="color:green">enabled</span>' : '<span style="color:red">disabled</span>') ," : ". $value['bp_restrictgroups_membership_count']['count'] ."</p>";
		...
		<form action="<?php echo network_admin_url('/admin.php?page=buddypress-restrict-grouo-creation-settings') ?>" name="restrictgroups-settings-form" id="restrictgroups-settings-form" method="post">

		<h4><?php _e( 'WP User Capabilities', 'buddypress-restrict-grouo-creation' ); ?></h4>

			<table class="form-table">
				<tr valign="top">
					<th scope="row"><label for="cap_low"><?php _e( 'User capability level', 'buddypress-restrict-grouo-creation' ) ?></label></th>
		...
		<h4><?php _e( 'Member Registered Since (Days)', 'buddypress-restrict-grouo-creation' ); ?></h4>	
	
			<table class="form-table">
				<tr>
					<th><label for="rg_days_count"><?php _e('Enable Days Since Threshold','buddypress-restrict-grouo-creation') ?></label></th>
		...
		<h4><?php _e( 'Count Threshold Settings', 'buddypress-restrict-grouo-creation' ); ?></h4>

			<table class="form-table">

				<?php if ( bp_is_active( 'friends' ) ) { ?>
				<tr>
					<th><label for="rg_friends_count"><?php _e('Enable Min Friends Count','buddypress-restrict-grouo-creation') ?></label></th>
				...
				<tr>
					<th><label for="rg_status_count"><?php _e('Enable Min Status Count','buddypress-restrict-grouo-creation') ?></label></th>
				...
				<tr>
					<th><label for="rg_post_count"><?php _e('Enable Min Forum Post Count','buddypress-restrict-grouo-creation') ?></label></th>
				...
				<tr>
					<th><label for="rg_membership_count"><?php _e('Enable Max Groups Memberships','buddypress-restrict-grouo-creation') ?></label></th>
				...
				<tr>
					<th><label for="rg_admin_count"><?php _e('Enable Max Groups Admin','buddypress-restrict-grouo-creation') ?></label></th>
				...
				<tr>
					<th><label for="rg_mod_count"><?php _e('Enable Max Groups Mod','buddypress-restrict-grouo-creation') ?></label></th>
				...
				<tr>
					<th><label for="rg_created_count"><?php _e('Enable Max Groups Created','buddypress-restrict-grouo-creation') ?></label></th>
				...
				if ( defined('ACHIEVEMENTS_IS_INSTALLED') && ACHIEVEMENTS_IS_INSTALLED == 1 ) { ?>
					<tr>
						<th><label for="rg_dpa_count"><?php _e('Enable Achievement Member Count Threshold','buddypress-restrict-grouo-creation') ?></label></th>
					...
					<tr>
						<th><label for="rg_dpa_score"><?php _e('Enable Achievement Member Score Threshold','buddypress-restrict-grouo-creation') ?></label></th>
			...
			<tr>
				<th><label for="rg_display_error"><?php _e('Display error message/reason on group directory page','buddypress-restrict-grouo-creation') ?></label></th>
