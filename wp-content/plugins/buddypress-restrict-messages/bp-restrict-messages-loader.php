...
function etivite_bp_restrict_messages_admin_add_admin_menu() {
	...
	add_submenu_page( 'options-general.php', __( 'Restrict Messages Admin', 'bp-restrict-messages' ), __( 'Restrict Messages', 'bp-restrict-messages' ), 'manage_options', 'bp-restrict-messages-settings', 'etivite_bp_restrict_messages_admin' );
