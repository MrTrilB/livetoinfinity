...
BuddyPress Private Community allows the site owner to lock the different BuddyPress components on the site for non-logged-in users. It also gives options to lockdown pages.
...
3. This screenshot shows the Custom Post Type options setting to screenshot-3.(png|jpg|jpeg|gif).
4. This screenshot shows the pages List options setting to screenshot-4.(png|jpg|jpeg|gif).
5. This screenshot shows the locked pages setting layout to screenshot-5.(png|jpg|jpeg|gif).
