<div class="wrap">
	...
	<div class="wbcom-wrap">
		...
		?>
		<h4 class="wbcom-plugin-heading"><?php esc_html_e( 'Paid Addons', 'bp-lock' ); ?></h4>
		...
		<h4 class="wbcom-plugin-heading"><?php esc_html_e( 'Free Addons', 'bp-lock' ); ?></h4>
		<div class="reign-demos-wrapper reign-importer-section">
			<div class="reign-demos-inner-wrapper wbcom-plugins-inner-wrapper">
				<?php
				$plugin_btn_text = esc_html__( 'View', 'bp-lock' );
