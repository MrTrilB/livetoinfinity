...
class Bp_Lock_Public {
	...
	public function bplock_enqueue_styles() {
		wp_enqueue_style( $this->plugin_name . '-font-awesome', BPLOCK_PLUGIN_URL . 'admin/css/font-awesome.min.css', $this->version, 'all' );
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/bp-lock-public.css', $this->version, 'all' );
	}
	 ...
	 *
	 * @param WP_Query $query instance (passed by reference).
	 */
