 ...
 */
class Buddypress_Ads_Rotator_Loader {
	...
	public function add_shortcode( $hook, $component, $callback ) {
		$this->shortcodes = $this->wb_ads_rotator_custom_add_shortcode( $this->shortcodes, $hook, $component, $callback );
	}
	 ...
	 */
	private function wb_ads_rotator_custom_add_shortcode( $hooks, $hook, $component, $callback ) {
