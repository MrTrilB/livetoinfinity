...
/*
  ...
  Plugin URI: https://toolset.com/course-lesson/using-framework-installer-to-install-reference-sites/?utm_source=local-ref-site&utm_medium=wpadmin&utm_term=visit-plugin-site&utm_content=plugins-page&utm_campaign=framework-installer
  Description: Download complete reference designs for Types and Views to your local test site.
  Author: OnTheGoSystems
  Author URI: http://www.onthegosystems.com
  Version: 3.1.17
 */
define('FIDEMO_VERSION', '3.1.17');
...
require_once FIDEMO_ABSPATH . '/vendor/autoload.php';
