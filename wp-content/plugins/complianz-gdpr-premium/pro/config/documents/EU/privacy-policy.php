...
$this->pages['eu']['privacy-statement']['document_elements'] = array(
    'last-updated' => array(
        'content' => '<i>' . cmplz_sprintf(_x('This privacy statement was last updated on %s and applies to citizens and legal permanent residents of the European Economic Area and Switzerland.', 'Legal document privacy statement', 'complianz-gdpr'), '[publish_date]') . '</i><br>',
    ),
    'inleiding' => array(
        'content' =>
    ...
    'third-party-sharing' => array(
        ...
        'content' => _x( "We only share this data with processors and with other third parties for which consent must be obtained. It concerns the following party or parties:", 'Legal document privacy statement', 'complianz-gdpr'),
