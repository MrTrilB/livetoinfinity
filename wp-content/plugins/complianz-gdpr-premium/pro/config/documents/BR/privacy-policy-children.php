...
$this->pages['br']['privacy-statement-children']['document_elements'] = array(
	'last-updated' => array(
		'content' => '<i>' . cmplz_sprintf(_x('This privacy statement was last changed on %s, was last checked on %s and applies to citizens and legal permanent residents of Brazil.', 'Legal document privacy statement', 'complianz-gdpr'), '[publish_date]', '[checked_date]') . '</i><br>',
	),

	'inleiding' => array(
		'p' => false,
		'content' =>
			'<p>'. cmplz_sprintf(_x('In this privacy statement, we explain what we do with the data we obtain about children via %s. We recommend you carefully read this statement. In our processing we comply with the requirements of Brazilian privacy legislation. That means, among other things, that:', 'Legal document privacy statement', 'complianz-gdpr'), '[domain]') .'</p>'.
			'<ul>
	...
	array(
		...
		'content' => _x('The General Law for the Protection of Personal Data (LGPD) requires that we search consent from a parent or guardian if we wish to collect personal data from a child. We use the following method(s):', 'Legal document privacy statement', 'complianz-gdpr')
	...
	array(
		...
		'p' => false,
		'content' => '<p>'._x('Verifiable parental consent is not required in the case of:', 'Legal document', 'complianz-gdpr').'</p>'.
			'<ol class="alphabetic">
	...
	array(
		'title' => _x('Disclosure practices', 'Legal document privacy statement', 'complianz-gdpr'),
