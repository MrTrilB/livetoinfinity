...
if ( ! class_exists( 'Bp_Checkins' ) ) :
	class Bp_Checkins {
		...
		private function define_public_hooks() {
			...
			$this->loader->add_action( 'bp_activity_get_embed_excerpt', $plugin_public, 'bpchk_show_google_map_in_checkin_emded_activity', 10, 2 );
			...
			$this->loader->add_action( 'bp_activity_post_form_options', $plugin_public, 'render_location_map_panle_html', 40 );
			...
			/* Embed activity */
			$this->loader->add_action( 'embed_head', $plugin_public, 'bp_checkin_activity_embed_add_inline_styles', 20 );
		}
