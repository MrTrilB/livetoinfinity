...
@media (max-width: 767px) {
	...
	.notice.bp-checkins-notice .bp-checkins-notice-inner .no-thanks {
		...
		public function set_no_bug() {
			...
			if ( ! isset( $_GET['_wpnonce'] ) || ( ! wp_verify_nonce( sanitize_text_field( wp_unslash( $_GET['_wpnonce'] ) ), 'bp-checkins-feedback-nounce' ) || ! is_admin() || ! isset( $_GET[ $this->nobug_option ] ) || ! current_user_can( 'manage_options' ) ) ) {
				return;
			}
